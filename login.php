    ...
    <div id="main-container">
        <div class="left">
            <div class="left-cont1">
                <h1>
                    Welcome to<span><img src="sl1.png" alt="stoke" style="position: relative; top: 16px; left:15px;"></span>
                </h1>
            ...
            <div class="left-cont2">
                <div class="flex" >
                    ...
                    <i class="fa fa-linkedin fa-lg"></i><i class="fa fa-facebook fa-lg" style="margin-left: 40px;"></i></i><i class="fa fa-twitter fa-lg" style="margin-left: 40px;"></i>
            ...
            <div class="right-cont1">
                    <div class="form1">
                        <form action="validation.php" class="register-form" method="POST">
                            ...
                            <input type="checkbox" style="width:auto;" required> I agree to Stoke <span><a href="#">Terms</a></span> and <span><a href="#">Policy</a></span>
                            </label>
